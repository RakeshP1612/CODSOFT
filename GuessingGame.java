...
public class GuessingGame {
    ...
    public static int startRound(int maxTries) {
        ...
        int targetNumber = random.nextInt(100) + 1;  // Generate a number from 1 to 100
        ...
        while (attemptsMade < maxTries) {
            ...
            if (userGuess == targetNumber) {
                ...
                return maxTries - attemptsMade + 1;  // Score based on attempts left
        ...
        return 0;  // No score if the number wasn't guessed
    }

    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        int maxTries = 7;  // Limit on attempts per round
        int overallScore = 0;
        int roundCounter = 1;
